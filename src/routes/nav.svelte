...
<div class="bg-purple-200 flex flex-row items-center p-2 sm:p-4">
	...
	<div class="flex-1" />
	<button class="btn black justify-center md:hidden" on:click={() => (show = !show)}>
	...
	<div in:slide out:slide class="hidden flex-row md:flex">
		...
		{#if $user}
			<button class="btn black justify-center" style:height="44px" title="Logout" on:click={logout}>
