...
>
    <div class="flex flex-row">
        ...
        <div class="flex-1" />
        {#if actions}
            <button class="rounded font-sans font-medium text-lg focus:outline-none focus:ring-2
...
<Modal bind:show={showConfirmation} trigger={false} title="Are you sure you want to delete this post?">
